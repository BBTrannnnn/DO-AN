document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadAttendance() {
        try {
            ...
            showNotification("Failed to load attendance.");
        }
    }
    ...
    async function addAttendance() {
        ...
        try {
            ...
            if (res.ok) {
                ...
                showNotification(data.message || "Failed to add attendance record.");
            }
        } catch (error) {
            console.error("Error adding attendance:", error);
            showNotification("Failed to add attendance record.");
        }
    }
    ...
    async function updateAttendance() {
        ...
        try {
            const res = await fetch(`/api/attendances/${selectedAttendanceId}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
            ...
            if (res.ok) {
                ...
                showNotification(data.message || "Failed to update attendance record.");
            }
        } catch (error) {
            console.error("Error updating attendance:", error);
            showNotification("Failed to update attendance record.");
        }
    }
    ...
    async function deleteAttendance() {
        try {
            ...
            if (res.ok) {
                ...
                showNotification(data.message || "Failed to delete attendance record.");
            }
        } catch (error) {
    ...
    async function fetchAttendanceDetails(id) {
        try {
            ...
            showNotification("Failed to load attendance details.");
        }
    }
